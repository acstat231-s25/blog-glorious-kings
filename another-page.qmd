...
Data_table_stats <- left_join(teammates_clean, Stats_stdz_c3, by = "Player") |>
  ...
  select(Player, Team.x, PTS, AST, Cluster)
...
The interactive table below allows you to search through all of LeBron's teammates and see which players are in what cluster, as well as the team they played with LeBron and their points and asisst averages.
