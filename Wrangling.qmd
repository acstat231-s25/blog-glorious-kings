...
page <- read_html(url3)
paths_allowed(url3)
teammates_table2 <- page |>
  html_element("table") |>
  html_table()
teammates_table2 <- teammates_table2 |>
  select('Player', 'Team(s)', 'GP', 'Win%')
write.csv(teammates_table2, "zydrunas_teammates.csv", row.names = FALSE)

url4 <- "https://basketball.realgm.com/player/Anderson-Varejao/Teammates/251"
page <- read_html(url4)
paths_allowed(url4)
teammates_table3 <- page |>
  html_element("table") |>
  html_table()
teammates_table3 <- teammates_table3 |>
  select('Player', 'Team(s)', 'GP', 'Win%')
write.csv(teammates_table3, "anderson_teammates.csv", row.names = FALSE)

url5 <- "https://basketball.realgm.com/player/James-Jones/Teammates/477"
page <- read_html(url5)
paths_allowed(url5)
teammates_table4 <- page |>
  html_element("table") |>
  html_table()
teammates_table4 <- teammates_table4 |>
  select('Player', 'Team(s)', 'GP', 'Win%')
write.csv(teammates_table4, "JamesJ_teammates.csv", row.names = FALSE)
...
# Matthew Dellavedova
url14 <- "https://basketball.realgm.com/player/Matt-Dellavedova/Teammates/8530"
page <- read_html(url7)
paths_allowed(url7)
...
# Richard Jefferson
url14 <- "https://basketball.realgm.com/player/Richard-Jefferson/Teammates/278"
page <- read_html(url8)
paths_allowed(url8)
...
# Mo Williams
url9 <- "https://basketball.realgm.com/player/Mo-Williams/Teammates/241"
page <- read_html(url9)
paths_allowed(url9)
teammates_mo <- page |>
  html_element("table") |>
...
# Kyle Korver
url10 <- "https://basketball.realgm.com/player/Kyle-Korver/Teammates/478"
page <- read_html(url10)
paths_allowed(url10)
...
# Anthony Davis
url11 <- "https://basketball.realgm.com/player/Anthony-Davis/Teammates/13305"
...
# Danny Green
url12 <- "https://basketball.realgm.com/player/Danny-Green/Teammates/1642"
page <- read_html(url12)
paths_allowed(url12)
